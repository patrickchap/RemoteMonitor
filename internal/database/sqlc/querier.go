...
type Querier interface {
	...
	GetHostServicesByStatus(ctx context.Context, status sql.NullString) ([]GetHostServicesByStatusRow, error)
	GetHostServicesStatuses(ctx context.Context) (GetHostServicesStatusesRow, error)
